tinymce.PluginManager.add('mosaic', function(editor, url) {
    // アイコン
    editor.ui.registry.addIcon('mosaic', '<img src="'+tinymce.activeEditor.getParam('document_base_url')+'/js/tinymce/plugins/mosaic/icon_mosaic.png" />');

    // プラグインボタンの追加
    // see) https://www.tiny.cloud/docs/advanced/creating-a-plugin/
    editor.ui.registry.addButton("mosaic", {
        icon: "mosaic",
        tooltip: "写真のAIモザイク",
        onAction: pluginWin,
        ...
        tinymce.activeEditor.windowManager.open({
            ...
            body: {
                ...
                items: [
                    ...
                    {
                        type: 'listbox',
                        name: 'mosaic_scale', // identifier
                        label: 'モザイクの強さ',
                        disabled: false,
                        items: [{ text: "強", value: "rough"},{text: "中", value: "medium"},{text: "細", value: "minute"}]
                    }
                ]
            },
            // 初期値設定
            ...
            onSubmit: function(api) {
                ...
                xhr.open('POST', tinymce.activeEditor.getParam('document_base_url') + '/upload/mosaic');
                ...
                xhr.onload = function() {
                    ...
                    document.getElementById('cc-mosaic-upload-' + frame_id).value = '';
                ...
                formData.append('mosaic', document.getElementById('cc-mosaic-upload-' + frame_id).files[0]);
