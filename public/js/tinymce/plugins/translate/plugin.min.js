tinymce.PluginManager.add('translate', function(editor, url) {
	editor.addButton("translate", { // プラグインボタンの追加
		icon: "plugin",
		image: "/js/tinymce/plugins/translate/plugin.png",
		tooltip: "翻訳",
			...
			onsubmit: function(e) { // OKボタンをクリックした際の挙動
				...
				xhr.onload = function() {
					...
					for (var i in json.return_texts) {
						tinymce.EditorManager.activeEditor.insertContent(json.return_texts[i]);
					}
				};
