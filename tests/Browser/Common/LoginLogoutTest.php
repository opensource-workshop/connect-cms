...
class LoginLogoutTest extends DuskTestCase
{
    ...
    private function loginTest()
    {
        ...
        // マニュアル用データ出力
        $dusk = Dusks::putManualData(['html_path' => 'common/index/index/index.html'],[
            'category' => 'common',
            'sort' => 2,
            'plugin_name' => 'index',
            'plugin_title' => 'ログイン関係',
    ...
    private function logoutTest()
    {
        ...
        // マニュアル用データ出力
        $dusk = Dusks::putManualData(['html_path' => 'common/index/logout/index.html'],[
            'category' => 'common',
            'sort' => 2,
            'plugin_name' => 'index',
            'plugin_title' => 'ログイン関係',
    ...
    private function resetTest()
    {
        ...
        // マニュアル用データ出力
        $dusk = Dusks::putManualData(['html_path' => 'common/index/reset/index.html'],[
            'category' => 'common',
            'sort' => 2,
            'plugin_name' => 'index',
            'plugin_title' => 'ログイン関係',
