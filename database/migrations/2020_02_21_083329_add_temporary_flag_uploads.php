...
class AddTemporaryFlagUploads extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('uploads', function (Blueprint $table) {
            //
            $table->integer('temporary_flag')->comment('一時フラグ')->default(0)->after('download_count');
            $table->integer('created_id')->nullable()->after('temporary_flag');
    ...
    public function down()
    {
        Schema::table('uploads', function (Blueprint $table) {
            //
            $table->dropColumn('temporary_flag');
