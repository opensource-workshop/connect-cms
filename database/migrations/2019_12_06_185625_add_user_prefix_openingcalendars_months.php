...
class AddUserPrefixOpeningcalendarsMonths extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('openingcalendars_months', function (Blueprint $table) {
            //
            $table->integer('created_id')->nullable()->after('comments');
