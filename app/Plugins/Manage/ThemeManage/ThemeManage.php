    ...
    */
    ...
    public function generateIndex($request, $page_id = null, $errors = array())
    {
        ...
        */
        ...
        $theme_set['craft-deepgreen']=['menu_horizon'=>'white|deepgreen|solid|craft','menu_vertical'=>'deepgreen|deepgreen|none|craft','frame_tittle'=>'deepgreen|deepgreen|solid|craft',];
        $theme_set['craft-deepred']=['menu_horizon'=>'white|deepred|solid|craft','menu_vertical'=>'deepred|deepred|none|craft','frame_tittle'=>'deepred|deepred|solid|craft',];
        $theme_set['craft-gray']=['menu_horizon'=>'white|gray|solid|craft','menu_vertical'=>'gray|gray|none|craft','frame_tittle'=>'gray|gray|solid|craft',];
        $theme_set['craft-green']=['menu_horizon'=>'white|green|solid|craft','menu_vertical'=>'green|green|none|craft','frame_tittle'=>'green|green|solid|craft',];
        ...
        $theme_set['craft-purple']=['menu_horizon'=>'deepblue|purple|solid|craft','menu_vertical'=>'deepblue|purple|none|craft','frame_tittle'=>'deepblue|purple|solid|craft',];
        */
        /* ledge */
        /*
        ...
        */
        ...
        $theme_set['shiny-gray']=['menu_horizon'=>'gray|gray|none|shiny','menu_vertical'=>'gray|gray|none|shiny','frame_tittle'=>'gray|gray|solid|shiny',];
...
EOM;
    ...
    private function getHorizonBkimageParam($val, $bkcolor) {
        //$background_image_filepath = '/images/core/theme/menu/horizon/' .$val .'/' .$bkcolor .'/images'. '/';
        $background_image_filepath = '/images/core/theme/menu/horizon/' .$val .'/' .$bkcolor;
        ...
        switch($val){
            ...
            case 'clear' : 
                $bk_param = [
                    'background-image'=> 'url(' .$background_image_filepath .'.gif)',
            ...
            case 'craft' : 
                $bk_param = [
                    'background-image' => 'url(' .$background_image_filepath .'.jpg)',
                    'background-repeat' => 'repeat-x',
            ...
            case 'shiny' : 
                $bk_param = [
                    'background-image' =>  'url(' .$background_image_filepath .'.png)',
...
EOM;
                    ...
                    if($val == 'craft'){
                        $background_image = $bk_param['background-image'];
                        $background_image_hover = str_replace('.jpg', '_on.jpg', $background_image);
                        $tmp_style .= <<<EOM
.plugin-menus .list-group > a.list-group-item.active,
.plugin-menus .list-group > a.list-group-item:hover {
    background-image : $background_image_hover;
...
EOM;
    ...
    private function getVerticalBkimageParam($val, $bkcolor) {
        $background_image_filepath = '/images/core/theme/menu/vertical/' .$val .'/' .$bkcolor;
        $background_code = self::COLORLIST[$bkcolor];
        $bk_param = [];
        switch($val){
            case 'none' : 
            ...
            case 'clear' : 
                $bk_param = [
                    'background-color' => $background_code.'80',
                ];
            break;
            case 'craft' : 
                $bk_param = [
...
EOM;
                    ...
                    if ($val == 'stitch'){
                        $background_image_filepath = '/images/core/theme/frame/' .$val .'/kuina.jpg';
                        $tmp_style .= <<<EOM
...
EOM;
    ...
    private function getFrameTittleBkimageParam($val, $bkcolor) {
        $background_image_filepath = '/images/core/theme/frame/' .$val .'/' .$bkcolor;
        $background_code = self::COLORLIST[$bkcolor];
        $bk_param = [];
