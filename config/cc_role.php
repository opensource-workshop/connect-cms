...
*/
    ...
    */
    ...
    'CC_METHOD_AUTHORITY' => [
        ...
        'saveBucketsRoles'    => ['frames.create'],
        'editBucketsMails'    => ['frames.edit'],
        'saveBucketsMails'    => ['frames.create'],
        'listCategories'      => ['frames.edit'],
        'saveCategories'      => ['frames.create'],
        'deleteCategories'    => ['frames.delete'],
        'editView'            => ['frames.edit'],
        'saveView'            => ['frames.create'],

        'addColumn'           => ['buckets.addColumn'],
        'addSelect'           => ['buckets.addColumn'],
        'editColumn'          => ['buckets.editColumn'],
        'editColumnDetail'    => ['buckets.editColumn'],
        'deleteColumn'        => ['buckets.deleteColumn'],
        'deleteSelect'        => ['buckets.deleteColumn'],
        'reloadColumn'        => ['buckets.reloadColumn'],
        // [TODO] upColumnSequence, downColumnSequenceは使われて無さそう
        'upColumnSequence'    => ['buckets.upColumnSequence'],
        'downColumnSequence'  => ['buckets.downColumnSequence'],
        'updateColumnSequence' => ['buckets.upColumnSequence', 'buckets.downColumnSequence'],
        'updateSelectSequence' => ['buckets.upColumnSequence', 'buckets.downColumnSequence'],
        // [TODO] saveColumnは使われて無さそう
        'saveColumn'          => ['buckets.saveColumn'],
        'updateColumn'        => ['buckets.saveColumn'],
        'updateColumnDetail'  => ['buckets.saveColumn'],
        'updateSelect'        => ['buckets.saveColumn'],
    ...
    'CC_METHOD_REQUEST_METHOD' => [
        ...
        'addSelect'           => ['post'],
        'editColumn'          => ['get'],
        'editColumnDetail'    => ['get'],
        'deleteColumn'        => ['post'],
        'deleteSelect'        => ['post'],
        'reloadColumn'        => ['post'],
        'upColumnSequence'    => ['post'],
        'downColumnSequence'  => ['post'],
        'updateColumnSequence' => ['post'],
        'updateSelectSequence' => ['post'],
        'saveColumn'          => ['post'],
        'updateColumn'        => ['post'],
        'updateColumnDetail'  => ['post'],
        'updateSelect'        => ['post'],
        'downloadCsv'         => ['post'],
        'import'              => ['get'],
