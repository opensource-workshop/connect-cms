...
$messages = [
    ...
    'main_regist' => '本登録',
    'required' => '必須',
    'image_authentication' => '画像認証',
    'captcha_placeholder' => '画像に表示されている文字を入力してください',
    'captcha_refresh_help' => '文字が読みづらい場合は、右側の更新ボタンで新しい画像に変更できます。',
    'captcha_refresh_error' => '画像の更新に失敗しました。ページを再読み込みしてください。',
    'to_list' => '一覧へ',
    'next' => '次へ',
    'previous' => '前へ',
    'temporary_save' => '一時保存',
    'to_regist' => '新規登録',
    'regist_application' => '登録申請',
    'regist_confirmed' => '登録確定',
    'change_application' => '変更申請',
    'change_confirmed' => '変更確定',
    'confirm_of_regist_application' => '登録申請します。\nよろしいですか？',
    'confirmed_of_regist_application' => '登録確定します。\nよろしいですか？',
    'confirm_of_change_application' => '変更申請します。\nよろしいですか？',
    'confirmed_of_change_application' => '変更確定します。\nよろしいですか？',
    'magazine_name' => '誌名',
    'meeting_name' => '会議名',
    ...
    'department' => '部署',
    'job_title' => '職名',
    'achievements_plus_keywords' => '保有業績タイプ＋キーワード',
