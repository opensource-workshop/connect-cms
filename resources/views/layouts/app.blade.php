...
@php
    ...
    if (isset($page) && isset($page_tree)) {
        ...
        $override_site_name = Configs::getConfigsValue($cc_configs, 'base_site_name', config('app.name', 'Connect-CMS'));
    }
@endphp
...
@endif
    ...
    <title>@if(isset($page)){{$page->page_name}} | @endif{{$override_site_name}}</title>
