...
<a class="btn btn-sm btn-link btn-light border"
    href="javascript:void window.open('http://twitter.com/intent/tweet?text={{urlencode($post_title)}}%20{{urlencode(url("/plugin/blogs/show/$page->id/$frame_id/$post->id/#frame-$frame->id"))}}','_blank');">
