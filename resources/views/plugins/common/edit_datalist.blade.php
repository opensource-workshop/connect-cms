        ...
        <div class="form-group">
            ...
            @foreach($plugins as $plugin)
                <tr @if ($plugin->id == $plugin_frame->id) class="active"@endif>
                    ...
                    <th><button class="btn btn-primary btn-sm" type="button" onclick="location.href='{{url('/')}}/plugin/{{$frame->plugin_name}}/editPlugin/{{$page->id}}/{{$frame_id}}/{{$plugin->id}}'"><i class="far fa-edit"></i> 設定変更</button></th>
