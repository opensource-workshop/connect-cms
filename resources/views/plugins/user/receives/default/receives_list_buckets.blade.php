...
<form action="/plugin/receives/changeBuckets/{{$page->id}}/{{$frame_id}}" method="POST" class="">
    ...
    <div class="form-group table-responsive">
        ...
        @foreach($receives as $receive)
            <tr @if ($receive_frame->receive_id == $receive->id) class="active"@endif>
    ...
    {{-- ページング処理 --}}
    @include('plugins.common.user_paginate', ['posts' => $receives, 'frame' => $frame, 'aria_label_name' => $frame->plugin_name_full . '選択', 'class' => 'form-group'])
