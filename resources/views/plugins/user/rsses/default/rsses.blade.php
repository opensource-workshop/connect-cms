            ...
            <div class="rsses-block-inner">
                <ul>
                    @foreach ($merge_urls as $item)
                        ...
                        @endphp
                        <li class="row"><div class="col pubdate">{{ $pubDate }}</div><div class="col title">{{ $rss_title }}</div><div class="col caption">{{ $caption }}</div><div class="col-6"><a href="{{ $link }}" target="_blank">{{ $title }}</a></div></li>
                    @endforeach
                </ul>
            </div>
                ...
                <div class="rsses-block-inner">
                    ...
                    @if (isset($urls->items))
                        ...
                        @foreach ($urls->items as $item)
                            ...
                            @endphp
                            <li class="row"><div class="col-2 pubdate">{{ $pubDate }}</div><div class="col"><a href="{{ $link }}" target="_blank">{{ $title }}</a></div></li>
                        @endforeach
                        </ul>
                    @else
