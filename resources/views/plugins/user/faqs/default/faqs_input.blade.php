...
@endif
    ...
    <div class="form-group">
        ...
        <input type="text" name="post_title" value="{{old('post_title', $faqs_posts->post_title)}}" class="form-control @if ($errors && $errors->has('post_text')) border-danger @endif">
    ...
    <div class="form-group">
        ...
        <div class="input-group date" id="posted_at" data-target-input="nearest">
            <input type="text" name="posted_at" value="{{old('posted_at', $faqs_posts->posted_at)}}" class="form-control datetimepicker-input col-md-3 @if ($errors && $errors->has('posted_at')) border-danger @endif" data-target="#posted_at">
    ...
    <div class="form-group">
        ...
        <input type="text" name="display_sequence" value="{{old('display_sequence', $faqs_posts->display_sequence)}}" class="form-control @if ($errors && $errors->has('display_sequence')) border-danger @endif">
    ...
    <div class="form-group">
        ...
        <input type="text" name="tags" value="{{old('tags', $faqs_posts_tags)}}" class="form-control @if ($errors && $errors->has('tags')) border-danger @endif">
