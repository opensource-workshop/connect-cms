...
--}}
        ...
        <div class="form-group row">
            <label class="col-sm-6 control-label">{{$form_column->column_name}} @if ($form_column->required)<label class="{{ App::getLocale() == Locale::ja ? 'badge badge-danger' : 'text-danger' }}">{{__('messages.required')}}</label> @endif</label>
