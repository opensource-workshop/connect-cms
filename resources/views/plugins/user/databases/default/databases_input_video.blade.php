...
@endif
<input name="databases_columns_value[{{$database_obj->id}}]" type="file" accept=".mp4" @if ($errors && $errors->has("databases_columns_value.$database_obj->id")) class="border border-danger" @endif>
