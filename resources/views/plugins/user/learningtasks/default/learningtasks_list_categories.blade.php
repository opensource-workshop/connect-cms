...
<script type="text/javascript">
    function form_delete(id) {
        if (confirm('カテゴリを削除します。\nよろしいですか？')) {
            form_delete_category.action = "/plugin/learningtasks/deleteCategories/{{$page->id}}/{{$frame_id}}/" + id;
            form_delete_category.submit();
        }
    }
</script>

<form action="/plugin/learningtasks/saveCategories/{{$page->id}}/{{$frame_id}}" method="POST" class="">
    {{ csrf_field() }}
        ...
        @foreach($general_categories as $category)
            <tr>
                <td nowrap>
                    ...
                    <input type="hidden" value="{{$category->learningtasks_categories_id}}" name="general_learningtasks_categories_id[{{$category->id}}]"></input>
        ...
        @foreach($plugin_categories as $category)
            <tr>
                <td nowrap>
                    ...
                    <input type="hidden" value="{{$category->learningtasks_categories_id}}" name="plugin_learningtasks_categories_id[{{$category->id}}]"></input>
