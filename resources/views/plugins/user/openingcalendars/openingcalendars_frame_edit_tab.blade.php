...
@if ($action == 'editBuckets')
    <li role="presentation" class="nav-item">
        <a href="{{url('/')}}/plugin/openingcalendars/editBuckets/{{$page->id}}/{{$frame->id}}#frame-{{$frame->id}}" class="nav-link active">開館カレンダー設定変更</a>
    </li>
@else
    <li role="presentation" class="nav-item">
...
@if ($action == 'createBuckets')
    <li role="presentation" class="nav-item">
        <a href="{{url('/')}}/plugin/openingcalendars/createBuckets/{{$page->id}}/{{$frame->id}}#frame-{{$frame->id}}" class="nav-link active">新規作成</a>
    </li>
@else
    <li role="presentation" class="nav-item">
...
@if ($action == 'listPatterns')
    <li role="presentation" class="nav-item">
        <a href="{{url('/')}}/plugin/openingcalendars/listPatterns/{{$page->id}}/{{$frame->id}}#frame-{{$frame->id}}" class="nav-link active">パターン</a>
    </li>
@else
    <li role="presentation" class="nav-item">
...
@if ($action == 'listBuckets')
    <li role="presentation" class="nav-item">
        <a href="{{url('/')}}/plugin/openingcalendars/listBuckets/{{$page->id}}/{{$frame->id}}#frame-{{$frame->id}}" class="nav-link active">選択</a>
    </li>
@else
    <li role="presentation" class="nav-item">
