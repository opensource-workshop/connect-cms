...
<form action="{{url('/')}}/plugin/openingcalendars/edit/{{$page->id}}/{{$frame_id}}#frame-{{$frame->id}}" method="POST" class="" name="chenge_ym">
    {{csrf_field()}}
...
<form action="{{url('/')}}/plugin/openingcalendars/save/{{$page->id}}/{{$frame_id}}#frame-{{$frame->id}}" method="POST" class="" name="chenge_plan">
    {{ csrf_field() }}
