...
{{-- <table class="table"><tr><td> --}}
    <div class="card-body">
        <ul class="nav nav-tabs">
            ...
            {{-- コア側のフレームメニュー --}}
            <li class="nav-item"><a href="{{URL::to('/')}}/plugin/blogs/frame_setting/{{$page->id}}/{{ $frame->id }}#{{ $frame->id }}" class="nav-link active">フレーム編集</a></li>
            <li class="nav-item"><a href="{{URL::to('/')}}/plugin/blogs/frame_delete/{{$page->id}}/{{ $frame->id }}#{{ $frame->id }}" class="nav-link">フレーム削除</a></li>
        </ul>
    </div>
