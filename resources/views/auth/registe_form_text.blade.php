...
@endphp
<input name="users_columns_value[{{$user_obj->id}}]" class="form-control" type="{{$user_obj->column_type}}" value="{{old('users_columns_value.'.$user_obj->id, $value)}}" placeholder="{{$user_obj->place_holder}}" id="{{$label_id}}">
